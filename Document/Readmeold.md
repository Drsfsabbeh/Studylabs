...
$ mkdir guest1 
$ cd guest1 
$ wget https://github.com/Drsfsabbeh/Studylabs/HDFS/PG2600.txt or https://github.com/bobbylovemovie/trainbigdata/raw/master 
...
```
$ cd guest1 
$ wget https://github.com/Drsfsabbeh/Studylabs/HDFS/wordcount.jar
or
...
or 
$ cp /home/cloudera/file_input/ml-100k.zip .
...
$ sudo rm flume.conf
$ sudo wget https://github.com/Drsfsabbeh/Studylabs/flume/flume.conf
or
...
$ mkdir spark
$ cd spark
$ wget https://github.com/Drsfsabbeh/Studylabs/Spark/mysql-connector-java-5.1.23.jar
or
...
$ mkdir spark
$ cd spark
$ wget https://github.com/Drsfsabbeh/Studylabs/Spark/StreamingWordCount.py
or
